package com.example.turing.turinginvestments;

import io.reactivex.rxjava3.core.Flowable;
import org.springframework.boot.autoconfigure.SpringBootApplication;
import ru.tinkoff.invest.openapi.OpenApi;
import ru.tinkoff.invest.openapi.example.TradingParameters;
...
public class TuringInvestmentsApplication {
    ...
    public static void main(String[] args) {
        ...
        tickers[0] = "BABA";
        CandleInterval[] intervals = new CandleInterval[1];
        intervals[0] = CandleInterval._10MIN;
        final TradingParameters parameters = new TradingParameters(
                "t.MB-JUQ3BqN86-fPDNNjwYsMtQILJ2-QLiK7ekUeXpjxQsomRa7RVdhUWZ2tCyaU809C73-k_qs6SegOOu5AmSA",
                tickers, intervals, true
        );
    ...
    private static org.slf4j.Logger initLogger() throws IOException {
        ...
        final var classLoader = TuringInvestmentsApplication.class.getClassLoader();
        ...
        return org.slf4j.LoggerFactory.getLogger(TuringInvestmentsApplication.class);
    }
